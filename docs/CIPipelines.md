...
| [PyodideRelease](/.github/workflows/release_pyodide.yml) | Called by Create Releases | Builds a Pyodide (WebAssembly) wheel on Ubuntu using `pyodide-build`, a host `protoc`, and a wasm protobuf library; validates wheel contents and publish-ready artifacts |
